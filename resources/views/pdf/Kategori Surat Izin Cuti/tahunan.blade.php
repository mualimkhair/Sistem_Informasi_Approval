...
<body>
    ...
    <div class="text-center">
        <div class="title text-bold">SURAT IZIN CUTI TAHUNAN</div>
        <div class="subtitle">Nomor : SI. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tahun {{ $tahun }}</div>
    </div>

    <div class="content">
        <div>1. Diberikan Cuti Tahunan untuk Cuti Tahun {{ $tahun_cuti }} Pegawai Negeri Sipil :</div>
        ...
        <ol type="a" class="list-ketentuan" style="text-align: justify;">
            <li>Sebelum menjalankan Cuti Tahunan wajib menyerahkan pekerjaannya kepada atasan langsung;</li>
