...
<html>
<head>
    <title>SURAT IZIN CUTI DI LUAR TANGGUNGAN NEGARA</title>
    <style>
...
<body>
    @php
        ...
        $kabandara_jabatan = $blangko?->kabandara?->jabatan ?? 'Plh. Kepala Kantor,';
    ...
    <div class="text-center">
        <div class="title text-bold">SURAT IZIN CUTI DI LUAR TANGGUNGAN NEGARA</div>
        <div class="subtitle">Nomor : SI. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tahun {{ $tahun }}</div>
    </div>

    <div class="content">
        <div>1. Diberikan Izin Cuti di Luar Tanggungan Negara kepada Pegawai Negeri Sipil :</div>
        ...
        <div style="text-align: justify;">
            Selama {{ $jumlah_hari }} hari kerja terhitung {{ $tanggal_mulai }} sampai dengan {{ $tanggal_selesai }} dengan ketentuan sebagai berikut :
        </div>
        
        <ol type="a" class="list-ketentuan" style="text-align: justify;">
            <li>Sebelum menjalankan Cuti di Luar Tanggungan Negara wajib menyerahkan pekerjaannya kepada atasan langsung;</li>
            <li>Setelah selesai menjalankan Cuti di Luar Tanggungan Negara, wajib melaporkan diri kepada atasan langsungnya dan bekerja kembali sebagaimana biasa.</li>
        </ol>
    ...
    <div class="signature-area">
        <div>Palu, &nbsp;&nbsp;&nbsp;{{ $bulan_tahun_surat }}</div>
        <br>
