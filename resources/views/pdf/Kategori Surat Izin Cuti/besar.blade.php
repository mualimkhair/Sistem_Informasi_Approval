...
<body>
    ...
    <div class="text-center">
        <div class="title text-bold">SURAT IZIN CUTI BESAR</div>
        <div class="subtitle">Nomor : SI. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tahun {{ $tahun }}</div>
    </div>

    <div class="content">
        <div>1. Diberikan Cuti Besar kepada Pegawai Negeri Sipil :</div>
        ...
        <ol type="a" class="list-ketentuan" style="text-align: justify;">
            <li>Sebelum menjalankan Cuti Besar wajib menyerahkan pekerjaan kepada atasan langsung.</li>
        ...
        <div style="text-align: justify;">
            2. Demikian Surat Izin Cuti Besar ini dibuat untuk dipergunakan sebagaimana mestinya.
        </div>
    </div>
