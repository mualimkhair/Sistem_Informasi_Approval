...
<html>
<head>
    <title>SURAT IZIN CUTI BERSALIN</title>
    <style>
...
<body>
    ...
    <div class="text-center">
        <div class="title text-bold">SURAT IZIN CUTI BERSALIN</div>
        <div class="subtitle">Nomor : SI. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tahun {{ $tahun }}</div>
    </div>

    <div class="content">
        <div>1. Diberikan cuti Bersalin kepada Pegawai Negeri Sipil :</div>
        ...
        <div style="text-align: justify;">
            Terhitung mulai tanggal {{ $tanggal_mulai }} s/d {{ $tanggal_selesai }} dengan ketentuan sebagai berikut :
        </div>
        
        <ol type="a" class="list-ketentuan" style="text-align: justify;">
            <li>Sebelum menjalankan Cuti Bersalin wajib menyerahkan pekerjaannya kepada atasan langsung.</li>
            <li>Segera Setelah persalinan yang bersangkutan memberitahukan tanggal persalinan kepada pejabat yang berwenang memberikan cuti.</li>
            <li>Setelah selesai menjalankan Cuti Bersalin, wajib melaporkan diri kepada atasan langsungnya dan bekerja kembali sebagaimana biasa.</li>
        </ol>

        <div style="text-align: justify;">
            2. Demikian Surat Izin Cuti Bersalin ini dibuat untuk dipergunakan sebagaimana mestinya.
        </div>
    </div>
