...
<body>
    ...
    <div class="text-center">
        <div class="title text-bold">SURAT IZIN CUTI ALASAN PENTING</div>
        <div class="subtitle">Nomor : SI. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tahun {{ $tahun }}</div>
    </div>

    <div class="content">
        <div>1. Diberikan Cuti Karena Alasan Penting kepada Pegawai Negeri Sipil :</div>
        ...
        <div style="text-align: justify;">
            Selama {{ $jumlah_hari }} hari terhitung mulai tanggal {{ $tanggal_mulai }} sampai dengan {{ $tanggal_selesai }} dengan ketentuan sebagai berikut :
        </div>
        
        <ol type="a" class="list-ketentuan" style="text-align: justify;">
            <li>Sebelum menjalankan Cuti Alasan Penting wajib menyerahkan pekerjaan kepada atasan langsung.</li>
            <li>Setelah menjalankan Cuti Alasan Penting wajib melaporkan diri kepada atasan langsungnya dan bekerja kembali sebagaimana biasa.</li>
        </ol>

        <div style="text-align: justify;">
            2. Demikian Surat Izin Cuti Karena Alasan Penting ini dibuat untuk dipergunakan sebagaimana mestinya.
        </div>
    </div>
